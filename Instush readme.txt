...
or not in a good format for this specific filter (the filter is working great with all pictures attached)
...
Please wait when using this filter otherwise the program will crush! Recomended to check the saved picture the result of this filter in full size picture is amazing. 
grayscal algorithem works as required wiht all kind of pictures. 
