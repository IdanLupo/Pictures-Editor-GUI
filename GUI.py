...
def parent_win():  # Main GUI function arranging all frames into the parent frame
    ...
    # Intro frame
    intro_lb = Label(intro, padx=200, pady=10, text="Instush Application GUI", bg="greenyellow",
    ...
    process_names = ["Rotate", "Mirror", "Resize", "Edge", "Dither", "Grayscale"]
